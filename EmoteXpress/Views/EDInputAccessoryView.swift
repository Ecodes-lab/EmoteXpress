...
protocol EDInputAccessoryViewDelegate: AnyObject {
    func inputView(_ inputView: EDInputAccessoryView, wantsToSend message: String)
}

class EDInputAccessoryView: UIView {

    // MARK: - Properties
    
    weak var delegate: EDInputAccessoryViewDelegate?
